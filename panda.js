/* number: 1
console.log(888); */ //testing the connection with html file
...
const RmvButton = document.getElementsByClassName('m-3');
...
function forNewImage() {
    document.getElementById('imgBag-1').src = 'images/bags/bag-2.png';
}
function forOldImage() {
    document.getElementById('imgBag-1').src = 'images/bags/bag-1.png';
}
...
sub.addEventListener('dblclick', function () {
    sub.style.backgroundColor = 'lightblue';
})
